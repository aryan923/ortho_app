...
<div class="page-heading">
    ...
    <p>Update the content and details of this post.</p>
</div>
    ...
    <form id="blog-form" method="POST" action="{{ route('admin.blogs.update', $blog) }}" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            ...
            <div class="form-field">
                ...
                @if($blog->image)
                    <div style="margin-bottom:8px;"><img src="{{ asset($blog->image) }}" alt="Current" style="height:60px;border-radius:8px;border:1px solid #e3e9f3;"></div>
                @endif
                <input id="image" name="image" type="file" accept="image/*">
            </div>
            <div class="form-field full-width">
                <label for="content">Content</label>
                <textarea id="content" name="content" rows="8">{{ old('content', $blog->content) }}</textarea>
            </div>
        </div>
